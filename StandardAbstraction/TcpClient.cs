...
namespace StandardAbstraction
{
    ...
    public class TcpClient : ITcpClient
    {
        ...
        /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="P:StandardAbstraction.ITcpClient.Connected"]/*'/>
        ...
        /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="P:StandardAbstraction.ITcpClient.Available"]/*'/>
        ...
        /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:StandardAbstraction.ITcpClient.Connect(System.Net.IPAddress,System.Int32)"]/*'/>
        ...
        /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:StandardAbstraction.ITcpClient.GetStream"]/*'/>
        public INetworkStream GetStream()
        {
            // Returning System.Net.Sockets.NetworkStream wrapped in an StandardAbstraction.NetworkStream (which implements INetworkStream), allows this method to be mocked
            System.Net.Sockets.NetworkStream networkStream = tcpClient.GetStream();
            return new NetworkStream(networkStream);
        }

        /// <include file='InterfaceDocumentationComments.xml' path='doc/members/member[@name="M:StandardAbstraction.ITcpClient.Close"]/*'/>
        public void Close()
        {
